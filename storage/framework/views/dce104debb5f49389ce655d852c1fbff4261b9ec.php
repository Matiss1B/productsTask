...
<div class="alignCenter justifyCenter flex w-max h-max" id ="product-list-title">
    ...
    <div class="flex col box bgs3 alignCenter justifyCenter padL2rem padR2rem">
        <div class="flex gap1 box2 alignCenter">
            <h1><?php echo e(session('user_id')); ?></h1>
        ...
        <div class="pad10px alignCenter none" id = "sidebar">
            ...
            <div class="flex col gap1 space-between w-max" id ="filter4">
                <div class="parent" value = "color">
                    ...
                    <div class="flex">
                        <input name = "color" type="checkbox" class = "checkbox" id="A-Z" value = "<?php echo e($color->color); ?>">
                        <label for="vehicle1"><?php echo e($color->color); ?></label>
                    </div>
                ...
                <div class="parent" value = "category_id">
                    ...
                    <?php $__currentLoopData = $categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex">
                            <input type="checkbox" class = "checkbox" value = "<?php echo e($category->id); ?>">
                            <label for="vehicle1"><?php echo e($category->category); ?></label>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class = "price">
    ...
    <div class="flex w-100vw pad2rem gap1 main1 wrap alignCenter justifyCenter">
        ...
        <div class="filter flex wrap gap1">
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex col single-product padT2rem alignCenter" id = "list" onclick="pop(<?php echo e($product->id); ?>)">
                        <img src="../storage/app/<?php echo e($product->img); ?>" alt="">
                        <h1><?php echo e($product->name); ?></h1>
                        <div class="test"></div>
                    </div>
                <div class="flex space-between pad10px bgs2 none popUp" id="popUp-<?php echo e($product->id); ?>">
                    <i class=" x fa fa-times" aria-hidden="true" onclick = "popUpHide(<?php echo e($product->id); ?>)"></i>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/products/resources/views/productList.blade.php ENDPATH**/ ?>